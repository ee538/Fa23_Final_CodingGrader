...
//-----------------------------------------------------------------------------
// Recursive solution. You can use a helper function.
int FindMaxTotalCost(std::vector<int> &costs);
//-----------------------------------------------------------------------------
// Memoization solution.
int FindMaxTotalCostMemo(std::vector<int> &costs);
//-----------------------------------------------------------------------------
// Memoization solution helper. n is the house index to consider.
int FindMaxTotalCostMemo_Helper(std::vector<int> &costs, int n,
                                std::vector<int> &memo);
//-----------------------------------------------------------------------------
// Tabulation solution.
...
std::vector<ResultTimesInMicroSeconds>
MeasureRunTimes(std::vector<std::vector<int>> inputs);
...
//        70, 6, 9, 8, 1,  5, 6, 70, 90, 4, 2, 1, 8, 5, 6, 7,  2, 3, 9}  // Size
//        40
// };

// auto output = {
//     {2, 1, 2},  // Output for input 1 (recursive, memo, tabulation) in
//     microseconds. {2, 1, 2},  // Output for input 2 (recursive, memo,
//     tabulation) in microseconds. {2, 1, 2},  // Output for input 3
//     (recursive, memo, tabulation) in microseconds.
// }
#endif /* SOL_2_Q */
